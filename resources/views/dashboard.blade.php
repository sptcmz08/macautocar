...
<body class="text-gray-900">
                ...
                <form action="{{ route('cars.update', $car) }}" method="POST" enctype="multipart/form-data" class="p-4 space-y-4">
                    ...
                    @if($car->status == 'stock')
                            ...
                            <div class="bg-{{ $expectedProfit >= 0 ? 'green' : 'red' }}-50 px-4 py-3 rounded-lg">
                                <div class="flex justify-between items-center">
                                    <span class="font-medium">คาดการณ์กำไร</span>
    ...
    <!-- Hidden form for refurbishment deletion -->
    <form id="refurbDeleteForm" method="POST" class="hidden">
        @csrf
        @method('DELETE')
    </form>
    ...
    <script>
        ...
        function deleteRefurb(refurbId) {
            if (confirm('ลบรายการปรับสภาพนี้?')) {
                var form = document.getElementById('refurbDeleteForm');
