                                    ...
                                    <td class="px-4 py-3 cursor-pointer" onclick="openEditModal({{ $car->id }})">
                                        ...
                                        <div class="text-xs text-gray-500 mt-1 leading-relaxed">
                                            <span class="inline-flex items-center gap-1">
                                                <span class="w-2 h-2 rounded-full inline-block" style="background: {{ $car->color == 'ขาว' ? '#e5e7eb' : ($car->color == 'ดำ' ? '#374151' : ($car->color == 'เทา' ? '#9ca3af' : ($car->color == 'เงิน' ? '#d1d5db' : ($car->color == 'น้ำเงิน' ? '#3b82f6' : ($car->color == 'แดง' ? '#ef4444' : '#f59e0b'))))) }}; border: 1px solid #d1d5db;"></span>
                                                {{ $car->color }}
                                            </span>
                                            @if($car->transmission)
