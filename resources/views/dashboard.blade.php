                        ...
                        @forelse($cars as $index => $car)
                            ...
                            <tr data-status="{{ $car->status }}"
                                ...
                                <td class="px-2 py-2 text-center">
                                    @if($car->images->count() > 0)
                                        <div class="relative cursor-pointer"
                                            ...
                                            <img src="{{ '/img/' . $firstImage->path }}" alt="Car Image"
                                                class="w-12 h-12 object-cover rounded-lg shadow-sm hover:scale-110 transition-transform">
                                    ...
                                    @else
                                        <div class="w-12 h-12 bg-gray-100 rounded-lg flex items-center justify-center text-gray-400 cursor-pointer"
                                ...
                                <!-- 3. Details -->
                                <td class="px-4 py-4 cursor-pointer" onclick="openEditModal({{ $car->id }})">
                                    ...
                                    <div class="text-xs text-gray-400 mt-0.5">{{ $car->purchase_date->format('Y-m-d') }} |
                                        {{ $car->color }}
                                    </div>
                                </td>
